        ...
        stage('Static Analysis') {
            parallel {
                ...
                stage('Qodana') {
                    ...
                    steps {
                        sh "docker run -v /workspace/MyFirstAndroidAppBuiltByJenkins:/data/project/ -v /workspace/MyFirstAndroidAppBuiltByJenkins/app/build/reports/qodana:/data/results/ -v /home/jenkins/:/data/cache/ --entrypoint='' jetbrains/qodana-jvm-android ls -artl /data/project"
